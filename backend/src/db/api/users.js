...
module.exports = class UsersDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.appointments_user = await users.getAppointments_user({
      transaction,
    });

    output.leads_assigned_user = await users.getLeads_assigned_user({
      transaction,
    });

    output.messages_user = await users.getMessages_user({
      transaction,
    });
