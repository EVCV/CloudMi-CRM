...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.analytics_organization =
      await organizations.getAnalytics_organization({
        transaction,
      });
    ...
    output.campaigns_organization =
      await organizations.getCampaigns_organization({
        transaction,
      });

    output.courses_organization = await organizations.getCourses_organization({
      transaction,
    });
    ...
    output.messages_organization = await organizations.getMessages_organization(
      {
        transaction,
      },
    );
