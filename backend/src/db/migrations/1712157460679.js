module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('messages', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('courses', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('campaigns', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('messages', 'userId', { transaction });

      await queryInterface.removeColumn('messages', 'sent_at', { transaction });

      await queryInterface.removeColumn('messages', 'channel', { transaction });
      ...
      await queryInterface.removeColumn('leads', 'last_name', { transaction });

      await queryInterface.removeColumn('leads', 'first_name', { transaction });
      ...
      await queryInterface.removeColumn('campaigns', 'status', { transaction });

      await queryInterface.removeColumn('campaigns', 'end_date', {
        transaction,
      });

      await queryInterface.removeColumn('campaigns', 'start_date', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('appointments', 'leadId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('analytics', 'value', { transaction });

      await queryInterface.removeColumn('analytics', 'metric_name', {
        transaction,
      });
